...
namespace Practica04.Controllers
{
    public class PrestamosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdPrestamo,IdLibro,IdUsuario,FechaPrestamo,FecDevolucion")] Prestamos prestamos)
        {
            ...
            ViewBag.IdLibro = new SelectList(db.Libro, "IdLibro", "Titulo", prestamos.IdLibro);
            ViewBag.IdUsuario = new SelectList(db.Usuario, "IdUsuario", "NIF", prestamos.IdUsuario);
            return View(prestamos);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdPrestamo,IdLibro,IdUsuario,FechaPrestamo,FecDevolucion")] Prestamos prestamos)
        {
            if (ModelState.IsValid)
            {
