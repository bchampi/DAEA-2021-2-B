...
namespace Lab15.Models
{
    ...
    public partial class SchoolEntities : DbContext
    {
        ...
        public virtual ObjectResult<SearchCourseByName_Result> SearchCourseByName(string title)
        {
            var titleParameter = title != null ?
                new ObjectParameter("Title", title) :
                new ObjectParameter("Title", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchCourseByName_Result>("SearchCourseByName", titleParameter);
        }
    
        public virtual ObjectResult<SearchPersonByName_Result> SearchPersonByName(string firstName)
        {
            var firstNameParameter = firstName != null ?
                new ObjectParameter("FirstName", firstName) :
                new ObjectParameter("FirstName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchPersonByName_Result>("SearchPersonByName", firstNameParameter);
        }
    
        public virtual ObjectResult<SearchPersonInGeneral_Result> SearchPersonInGeneral(string input)
        {
            var inputParameter = input != null ?
                new ObjectParameter("input", input) :
                new ObjectParameter("input", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchPersonInGeneral_Result>("SearchPersonInGeneral", inputParameter);
        }
